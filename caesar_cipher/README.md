...
Notes:
1. The program automatically recognizes the language. Does not recognize the case when a string contains words in different languages.
2. Bonus encryption: each word of a string is encrypted with a cyclic shift to the length.
2. Non-alphabetic characters - punctuation, spaces, numbers - do not change. 
3. Save the case of characters. 
...
### Output example
```
Hello! This program encrypts/decrypts text with the Caesar cipher.
Do you want to decrypt or encrypt your text? (D - decrypt, E - encrypt)
e
Please enter the string you want to encrypt. Languages available: english and russian.
The quick brown fox
Please, enter the encryption step.
6
Znk waoiq hxuct lud

Bonus! Secure encryption: each word of a string is encrypted with a cyclic shift to the length of the word.
Wkh vznhp gwtbs ira 

Would you like to do this again? Y - yes, N - no.
y

Hello! This program encrypts/decrypts text with the Caesar cipher.
Do you want to decrypt or encrypt your text? (D - decrypt, E - encrypt)
d
Please enter the string you want to decrypt. Languages available: english and russian.
Да, л юшзеа ьаесч пэыщ!
Please, enter the decryption step.
13
